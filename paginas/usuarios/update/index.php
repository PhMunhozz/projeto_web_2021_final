  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-danger pull-right" href="../delete/?ref=<?php echo $id; ?>" style="float: right;">Remover Usuário<div class="ripple-container"></div></a>
            </div>
        </div>
        <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <label class="bmd-label-floating">Nome</label>
                          <input type="text" class="form-control" name="nome" id="inputNome" value="<?php echo $usuario['nome'] ?>">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Usuário</label>
                          <input type="text" class="form-control" name="usuario" id="inputUsuario" value="<?php echo $usuario['usuario'] ?>">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Senha</label>
                          <input type="password" class="form-control" name="senha" id="inputSenha" value="******">
                        </div>
                      </div>
                    </div>
