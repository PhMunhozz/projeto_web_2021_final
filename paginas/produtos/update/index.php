  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-danger pull-right" href="../delete/?ref=<?php echo $id; ?>" style="float: right;">Remover Produto<div class="ripple-container"></div></a>
            </div>
        </div>
        <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="form-group bmd-form-group">
                              ...
                              <textarea class="form-control" rows="10" name="descricao"> <?php echo $produto['descricao'] ?> </textarea>                                                        
                          </div>
                      </div>
                    </div>
