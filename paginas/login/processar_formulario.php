            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        ?>
                        <h3 style="color: whitesmoke;">Login efetuado!</h3>
                            <script>
                                setTimeout(function() {
                        ...
                        ?>
                            <h3 style="color: whitesmoke;">Dados inválidos! Tente novamente.</h3>
                            <button onclick="history.back();" type="submit" class="btn btn-primary pull-right" style="float: left;">Voltar</button>
                        <?php
                                }
                            } else{
