                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="processar_formulario.php" method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group bmd-form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="usuario" id="inputUsuario" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group bmd-form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary pull-right" style="float: right;">Entrar</button>
