                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <label class="bmd-label-floating">Nome</label>
                          <input type="text" class="form-control" name="nome" id="inputNome" value="<?php echo $categoria['nome'] ?>" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <select class="form-control" name="situacao" id="inputSituacao">
                            <?php
                                $situacao1 = $categoria['situacao'] == 1 ? 'Ativado' : 'Desativado';
                                $situacao2 = $categoria['situacao'] == 0 ? 'Ativado' : 'Desativado';
